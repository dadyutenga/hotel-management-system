...
<aside class="sidebar">
    ...
    <div class="sidebar-brand">
        ...
        <div class="brand-content">
            ...
            <p class="brand-subtitle">Housekeeper</p>
        </div>
    </div>
    ...
    <nav class="sidebar-menu">
        ...
        <div class="menu-section">
            <span class="section-label">My Tasks</span>
        </div>

        <a href="{{ route('tenant.housekeeper.tasks.index') }}" class="menu-item {{ request()->routeIs('tenant.housekeeper.tasks.*') ? 'active' : '' }}">
