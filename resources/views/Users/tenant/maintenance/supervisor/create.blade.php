...
<head>
    ...
    <title>Create Maintenance Request - HotelPro</title>
        ...
        <div class="main-content">
            <div class="container">
                ...
                <div class="header">
                    ...
                    <p>Report and assign a new maintenance issue</p>
                </div>
                            ...
                            <div class="form-grid single">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="location_details" id="location_details" class="form-control" 
                                           value="{{ old('location_details') }}" placeholder="e.g., Main Lobby, Parking Area, Roof">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="issue_type" id="issue_type" class="form-control" 
                                           value="{{ old('issue_type') }}" placeholder="e.g., Plumbing, Electrical, HVAC" required>
                                    @error('issue_type')
                                        <span class="error-message">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <select name="housekeeper_ids[]" id="housekeeper_ids" class="form-control" multiple>
                                        @foreach($housekeepers as $housekeeper)
                                            <option value="{{ $housekeeper->id }}" 
                                                {{ (is_array(old('housekeeper_ids')) && in_array($housekeeper->id, old('housekeeper_ids'))) ? 'selected' : '' }}>
