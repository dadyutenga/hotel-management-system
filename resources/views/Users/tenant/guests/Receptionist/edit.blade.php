...
<head>
    ...
    <title>Edit Guest - {{ config('app.name') }}</title>
        ...
        <div class="main-content">
            <div class="container">
                <div class="header">
                    ...
                    <p>Update guest information for {{ $guest->full_name }}</p>
                </div>

                @if($guest->updated_at && $guest->updater)
                    <div class="update-info">
                        <i class="fas fa-info-circle"></i>
                        Last updated on {{ $guest->updated_at->format('M d, Y \a\t h:i A') }} by {{ $guest->updater->name }}
                    </div>
                @endif
                ...
                <form action="{{ route('tenant.guests.update', $guest->id) }}" method="POST" class="form-container">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nationality" name="nationality" class="form-control" 
                                       value="{{ old('nationality', $guest->nationality) }}" list="nationalities">
                        ...
                        <div class="form-grid single">
                            <div class="form-group">
                                ...
                                <textarea id="notes" name="notes" class="form-control" 
                                          placeholder="Any special requests, preferences, or important information...">{{ old('notes', $guest->notes) }}</textarea>
                                @error('notes')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="checkbox-group">
                                <input type="checkbox" id="marketing_consent" name="marketing_consent" 
                                       value="1" {{ old('marketing_consent', $guest->marketing_consent) ? 'checked' : '' }}>
                    ...
                    <div class="form-actions">
                        <a href="{{ route('tenant.guests.show', $guest->id) }}" class="btn btn-secondary">
