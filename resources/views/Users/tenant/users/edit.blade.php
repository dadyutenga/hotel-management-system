...
<head>
    ...
    <title>Edit User - HotelPro</title>
            ...
            <div class="header">
                <div class="header-left">
                    ...
                    <div class="breadcrumb">
                        ...
                        <a href="{{ route('tenant.users.show', $user->id) }}">{{ $user->username }}</a>
                        <i class="fas fa-chevron-right"></i>
                        <span>Edit</span>
                    </div>
                </div>
            ...
            <div class="content">
                ...
                <div class="form-container">
                    <div class="form-header">
                        ...
                        <p>Update user information for {{ $user->full_name }}</p>
                    </div>
                    
                    <form action="{{ route('tenant.users.update', $user->id) }}" method="POST" class="form-content">
                        @csrf
                        @method('PUT')
